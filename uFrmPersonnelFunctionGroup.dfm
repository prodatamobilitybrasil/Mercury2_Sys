inherited FrmPersonnelFunctionGroup: TFrmPersonnelFunctionGroup
  Tag = 133
  Left = 437
  Top = 264
  Width = 686
  Height = 420
  Caption = 'Grupos de Cargos de Operadores'
  PixelsPerInch = 96
  TextHeight = 13
      ...
      inherited gbGrid: TGroupBox
        ...
        inherited grdResultado: TDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'PFG_STATUS'
              Title.Caption = 'Status'
              Visible = False
            end
            item
              Expanded = False
              FieldName = 'PFG_REGUSER'
              Title.Caption = 'Usu'#225'rio'
              Visible = False
            end
            item
              Expanded = False
              FieldName = 'PFG_REGDATE'
              Title.Caption = 'Data'
              Visible = False
            end>
        end
  ...
  inherited dtsMaster: TDataSource
    DataSet = DmSys.cdsPersonnelFunctionsGroup
  end
end
